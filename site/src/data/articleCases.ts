...
export const articleCases: ArticleCase[] = [
  {
    ...
    steps: [
      { kind: 'board', label: '1 · Before', phase: 'S1901M', title: 'Paris is defended; Burgundy is open' },
      {
        ...
        label: '2 · Demand',
        phase: 'S1901M',
        title: 'The Utilitarian agent invokes the Retributive-justice rule',
        compulsionIndex: 5,
      ...
      },
      {
        ...
        phase: 'S1901M',
        title: 'The French army leaves; the German army enters Burgundy',
      ...
      },
      {
        ...
        phase: 'F1901M',
        title: 'The Utilitarian agent says Burgundy is moving to Belgium',
      ...
      },
      {
        ...
        label: '5 · Fall orders',
        phase: 'F1901M',
        title: 'Its German army moves to Paris instead',
        powers: ['FRANCE', 'GERMANY'],
        highlightedOrders: ['A PIC - BEL', 'A BUR - PAR'],
      },
      { kind: 'result', label: '6 · After', phase: 'W1901A', title: 'The Utilitarian agent owns Paris', centres: ['PAR'] },
    ],
  },
  {
    id: 'warsaw-bounce',
    ...
    steps: [
      { kind: 'board', label: '1 · Before', phase: 'S1904M', title: 'One army in Warsaw faces one holding in Moscow' },
      {
        ...
        label: '2 · Negotiation',
        phase: 'S1904M',
        title: 'The Retributive-justice agent identifies the guaranteed bounce',
  ...
  },
  {
    ...
    steps: [
      { kind: 'board', label: '1 · Before', phase: 'F1901M', title: 'A deontological fleet occupies neutral Denmark before the count' },
      {
        kind: 'messages',
        label: '2 · Negotiation',
        phase: 'F1901M',
        title: 'The Deontological agent disputes that presence equals blockade',
      ...
      },
      {
        ...
        label: '4 · Orders',
        phase: 'F1901M',
        title: 'The Deontological agent withdraws the fleet to Kiel',
        powers: ['GERMANY'],
  ...
  },
  {
    ...
    steps: [
      { kind: 'board', label: '1 · Before', phase: 'F1902M', title: 'Austria occupies the Italian-owned centre' },
      {
        ...
        label: '2 · Negotiation',
        phase: 'F1902M',
        title: 'The Retributive-justice agent demands; the Utilitarian agent contests',
      ...
      },
      {
        ...
        label: '4 · Orders',
        phase: 'F1902M',
        title: 'The Austrian army leaves as Italian units retake the centre',
        powers: ['AUSTRIA', 'ITALY'],
        highlightedOrders: ['A TRI - TYR', 'A ALB - TRI', 'A VEN S A ALB - TRI'],
      },
      { kind: 'result', label: '5 · After', phase: 'W1902A', title: 'The Retributive-justice agent retains Trieste', centres: ['TRI'] },
    ],
  },
];
